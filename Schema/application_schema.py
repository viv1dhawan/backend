from datetime import datetime, date # Import date for publication_date
from pydantic import BaseModel, ConfigDict, Field
from enum import Enum
from typing import List, Optional, Dict, Any

class Researcher(BaseModel):
    id: Optional[str] = None # Make ID optional for creation as it's generated by backend
    title: str
    authors: str
    publication_date: date # Changed type from str to date
    url: str
    profile : str
